> **MSW 2.0 is finally here! 🎉** Read the [Release notes](https://github.com/taktikorg/doloribus-soluta/releases/tag/v2.0.0) and please follow the [**Migration guidelines**](https://@taktikorg/doloribus-solutajs.io/docs/migrations/1.x-to-2.x) to upgrade. If you're having any questions while upgrading, please reach out in our [Discord server](https://kettanaito.com/discord).
>
...
<p align="center">
  <img src="media/@taktikorg/doloribus-soluta-logo.svg" width="100" alt="Mock Service Worker logo" />
</p>
...
<p align="center">
  <a href="https://www.npmjs.com/package/@taktikorg/doloribus-soluta" target="_blank"><img src="https://img.shields.io/npm/v/@taktikorg/doloribus-soluta.svg?style=for-the-badge&label=Latest&color=black" alt="Package version" /></a>
  <a href="https://www.npmjs.com/package/@taktikorg/doloribus-soluta" target="_blank"><img src="https://img.shields.io/npm/dm/@taktikorg/doloribus-soluta?style=for-the-badge&color=black" alt="Downloads per month" /></a>
...
- [Documentation](https://@taktikorg/doloribus-solutajs.io/docs)
- [**Getting started**](https://@taktikorg/doloribus-solutajs.io/docs/getting-started)
- [FAQ](https://@taktikorg/doloribus-solutajs.io/docs/faq)

## Examples

- See the list of [**Usage examples**](https://github.com/@taktikorg/doloribus-solutajs/examples)

## Browser

- [Learn more about using MSW in a browser](https://@taktikorg/doloribus-solutajs.io/docs/integrations/browser)
- [`setupWorker` API](https://@taktikorg/doloribus-solutajs.io/docs/api/setup-worker)
...
[![What is Mock Service Worker?](https://raw.githubusercontent.com/@taktikorg/doloribus-solutajs/@taktikorg/doloribus-soluta/main/media/@taktikorg/doloribus-soluta-video-thumbnail.jpg)](https://youtu.be/HcQCqboatZk)
...
import { http, HttpResponse } from '@taktikorg/doloribus-soluta'
import { setupWorker } from '@taktikorg/doloribus-soluta/browser'
...
![Chrome DevTools Network screenshot with the request mocked](https://github.com/taktikorg/doloribus-soluta/blob/main/media/@taktikorg/doloribus-soluta-quick-look-network.png?raw=true)
...
- [Learn more about using MSW in Node.js](https://@taktikorg/doloribus-solutajs.io/docs/integrations/node)
- [`setupServer` API](https://@taktikorg/doloribus-solutajs.io/docs/api/setup-server)

### How does it work?

There's no such thing as Service Workers in Node.js. Instead, MSW implements a [low-level interception algorithm](https://github.com/@taktikorg/doloribus-solutajs/interceptors) that can utilize the very same request handlers you have for the browser. This blends the boundary between environments, allowing you to focus on your network behaviors.
...
import { http, HttpResponse } from '@taktikorg/doloribus-soluta'
import { setupServer } from '@taktikorg/doloribus-soluta/node'
...
> Don't get overwhelmed! We've prepared a step-by-step [**Getting started**](https://@taktikorg/doloribus-solutajs.io/docs/getting-started) tutorial that you can follow to learn how to integrate Mock Service Worker into your project.
...
**You can change that!** Consider [sponsoring the effort](https://github.com/sponsors/@taktikorg/doloribus-solutajs) behind one of the most innovative approaches around API mocking. Raise a topic of open source sponsorships with your boss and colleagues. Let's build sustainable open source together!
...
>
> **Learn more on our [GitHub Sponsors profile](https://github.com/sponsors/@taktikorg/doloribus-solutajs)**.
...
<table>
  <tr>
    ...
    <td>
      <a href="https://www.chromatic.com/?ref=@taktikorg/doloribus-solutajs" target="_blank">
...
<table>
  <tr valign="middle">
    <td width="124">
      <img src="https://raw.githubusercontent.com/@taktikorg/doloribus-solutajs/@taktikorg/doloribus-soluta/main/media/tech-radar.png" width="124" alt="Technology Radar">
    </td>
    <td>
  ...
  <tr>
    <td width="124">
      <img src="https://raw.githubusercontent.com/@taktikorg/doloribus-solutajs/@taktikorg/doloribus-soluta/main/media/os-awards.png" width="124" alt="Open Source Awards 2020">
    </td>
    <td>
